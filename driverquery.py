...
# 
# Author:
#   Alberto Solino (@agsolino) - original wmiquery.py code; modified by dru1d (dru1d@dru1d.ninja)
#
# Reference for:
#  DCOM
#
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(add_help = True, description = "Executes Win32_SystemDriver query "
                                                                    "using Windows Management Instrumentation for remote driver enumeration.")
    ...
    if options.outputfile:
        ...
        print(f"[+] Saving output to file {options.outputfile}")
    ...
    try:
        ...
        execute_single_query(iWbemServices, 'SELECT * FROM Win32_SystemDriver')
